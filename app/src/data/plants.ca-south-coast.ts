...
export const SEED_RAW: RawPlant[] = [
  ...
  // ---------------- CONIFERS ----------------
  // The list shipped with none, which made cismontane southern California look
  // like a place with no evergreen trees in it. It has four worth a garden: the
  // region's own cypress, its two pines, and the small slow juniper of the
  // inland valleys. Every one of them wants the same thing — full sun, sharp
  // drainage, and no summer water once it is up.
  {
    id: "hesperocyparis-forbesii",
    common: "Tecate Cypress",
    latin: "Hesperocyparis forbesii",
    family: "Cupressaceae",
    form: "tree",
    nativeNote: "Southern California's only native cypress, and one of the rarest trees in the state: four wild groves, on Sierra Peak in the Santa Ana Mountains and on Otay, Tecate and Guatay in San Diego County, then south into Baja.",
    sun: { minHours: 6, maxHours: 12 },
    moisture: ["dry"],
    ph: { min: 5.5, max: 7.5 },
    zones: { min: 8, max: 10 },
    ...
    matureHeightFt: 30,
    matureSpreadFt: 20,
    scores: { pollinator: 3, bird: 62, stormwater: 55, erosion: 74, carbon: 62, establishment: 70 },
    hostLepCount: 8,
    keystone: false,
    bloom: null,
  ...
  },
  {
    id: "pinus-torreyana",
    common: "Torrey Pine",
    latin: "Pinus torreyana",
    family: "Pinaceae",
    form: "tree",
    nativeNote: "The rarest pine in North America, wild in two places only — the sandstone bluffs north of San Diego, and Santa Rosa Island off Santa Barbara. About nine thousand trees in the world.",
    sun: { minHours: 6, maxHours: 12 },
    moisture: ["dry"],
    ph: { min: 6.0, max: 8.0 },
    zones: { min: 9, max: 10 },
    size: [
      ...
      { year: 5, heightFt: 16, spreadFt: 10 },
      { year: 10, heightFt: 28, spreadFt: 20 },
    ],
    matureHeightFt: 50,
    matureSpreadFt: 45,
    scores: { pollinator: 4, bird: 78, stormwater: 62, erosion: 70, carbon: 80, establishment: 74 },
    hostLepCount: 140,
    keystone: true,
    bloom: null,
    filters: { deerResistant: true, thorny: false, allergenic: true, petToxic: false, aggressive: false },
  ...
  },
  {
    id: "pinus-coulteri",
    common: "Coulter Pine",
    latin: "Pinus coulteri",
    family: "Pinaceae",
    form: "tree",
    nativeNote: "The pine of the inland foothills and chaparral slopes — Mount Wilson to Palomar, from about five hundred feet up, through the Transverse and Peninsular ranges to the border.",
    sun: { minHours: 6, maxHours: 12 },
    moisture: ["dry"],
    ph: { min: 5.5, max: 7.5 },
    zones: { min: 7, max: 9 },
    ...
    matureHeightFt: 70,
    matureSpreadFt: 40,
    scores: { pollinator: 4, bird: 80, stormwater: 64, erosion: 72, carbon: 86, establishment: 76 },
    hostLepCount: 140,
    keystone: true,
    bloom: null,
    filters: { deerResistant: true, thorny: false, allergenic: true, petToxic: false, aggressive: false },
    ...
    propagation: {
      methods: ["seed-cold-moist", "seed-direct"],
      note: "The cones open slowly on the tree over a couple of years. Gather seed as it drops, or prise a gaping cone apart — carefully, every scale ends in a hooked spine. A month cold and damp in the fridge evens up germination. Deep pot again, or sow it straight where it is to grow.",
      basis: "USFS Native Plant Network; Woody Plant Seed Manual.",
    },
  },
  {
    id: "juniperus-californica",
    common: "California Juniper",
    latin: "Juniperus californica",
    family: "Cupressaceae",
    form: "tree",
    nativeNote: "The juniper of the dry interior — the inland valleys and foothills behind San Diego and Los Angeles, and on east to where the desert begins.",
    sun: { minHours: 6, maxHours: 12 },
    moisture: ["dry"],
    ph: { min: 6.5, max: 8.5 },
    zones: { min: 7, max: 10 },
    size: [
      { year: 1, heightFt: 0.8, spreadFt: 0.5 },
    ...
    matureHeightFt: 15,
    matureSpreadFt: 15,
    scores: { pollinator: 3, bird: 84, stormwater: 45, erosion: 76, carbon: 40, establishment: 78 },
    hostLepCount: 12,
    keystone: false,
    bloom: null,
    filters: { deerResistant: true, thorny: false, allergenic: true, petToxic: false, aggressive: false },
    noWaterEstablish: true,
    careNote: "The slowest plant in this list — two to four inches of height in a year — and that is the point: a tree that stays a small tree, on a hot bank, on no water at all. Full sun and drainage; it takes alkaline and salty soil that would kill most of the rest of this list. Don't shear it into a ball, and don't plant it tight against a wooden wall in fire country, where a resinous evergreen is the wrong thing next to the house.",
