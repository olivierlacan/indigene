...
export const fr: Dict = {
  ...
  "import.lookalike": "{name}, une plante envahissante, lui ressemble. Vérifiez que la vôtre est bien l'indigène avant de l'ajouter.",
  ...
  "spot.invasivesTitle": "Plantes envahissantes à traiter",
  ...
  "badge.deerResistant": "Évitée des chevreuils",
