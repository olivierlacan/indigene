...
| Path | What it is |
|---|---|
| [`app/`](app/) | The PWA — vanilla TypeScript on the DOM, no framework, zero runtime deps, ~432 KB gzipped plus the one region you garden in (9–38 KB). This is the product. Offline-first, installable. |
