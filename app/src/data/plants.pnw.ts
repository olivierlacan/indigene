...
export const SEED_RAW: RawPlant[] = [
...

  {
    ...
    family: "Rosaceae",
    form: "shrub",
    nativeNote: "The soft, thornless bramble of clearings, road edges and open woods, Alaska down to the Sierra.",
    sun: { minHours: 2, maxHours: 9 },
    moisture: ["mesic", "wet"],
    ph: { min: 5.0, max: 7.0 },
    zones: { min: 3, max: 9 },
    ...
    matureHeightFt: 8,
    matureSpreadFt: 15,
    scores: { pollinator: 76, bird: 84, stormwater: 66, erosion: 82, carbon: 22, establishment: 90 },
    hostLepCount: 120,
    keystone: true,
    bloom: { startMonth: 5, endMonth: 7, color: "white" },
    filters: { deerResistant: false, thorny: false, allergenic: false, petToxic: false, aggressive: true },
...

  {
    ...
    family: "Papaveraceae",
    form: "perennial",
    nativeNote: "The ferny woodland bleeding heart of damp west-side forest floors, British Columbia to central California.",
    sun: { minHours: 0, maxHours: 5 },
    moisture: ["mesic", "wet"],
    ph: { min: 5.0, max: 7.0 },
    zones: { min: 5, max: 9 },
    size: [
      ...
      { year: 5, heightFt: 1.3, spreadFt: 3 },
      { year: 10, heightFt: 1.3, spreadFt: 5 },
    ],
    matureHeightFt: 1.5,
    matureSpreadFt: 6,
    scores: { pollinator: 62, bird: 25, stormwater: 45, erosion: 62, carbon: 8, establishment: 80 },
    hostLepCount: 2,
    keystone: false,
    bloom: { startMonth: 3, endMonth: 7, color: "pink" },
    filters: { deerResistant: true, thorny: false, allergenic: false, petToxic: true, aggressive: false },
    noWaterEstablish: false,
