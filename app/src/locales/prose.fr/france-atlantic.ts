...
export const FRANCE_ATLANTIC: ProseTable = {
  ...
  "Alnus glutinosa": {
    ...
    supportNotes: {
      ...
      "conifer-seed-finches":
        "Les petits cônes ligneux de l'aulne gardent leur graine tout l'hiver, et tarins et sizerins les décortiquent suspendus la tête en bas en bandes jacassantes — l'image classique d'un mois de janvier au bord d'une rivière française.",
    },
  },
  "Populus tremula": {
    nativeNote:
    ...
    supportNotes: {
      ...
      "mason-bees":
        "Le tremble est pollinisé par le vent et ne demande rien à un insecte, mais il lâche une quantité énorme de pollen en mars et les abeilles solitaires précoces le récoltent quand même — une aubaine au moment du printemps où il n'y a presque rien d'autre.",
    },
  },
  "Fagus sylvatica": {
    nativeNote:
  ...
  "Crataegus monogyna": {
    ...
    supportNotes: {
      ...
      "bumble-bees":
        "L'écume de fleurs d'aubépine en mai est l'une des plus grosses miellées de l'année dans une haie.",
    },
  },
  "Prunus spinosa": {
    nativeNote:
  ...
  "Ilex aquifolium": {
    ...
    removal: {
      steps: [
        "Arrachez les semis, racine comprise, quand le sol est mouillé.",
        "Coupez les sujets plus grands au pied et dessouchez, ou coupez chaque rejet jusqu'à ce qu'il abandonne.",
        "Surveillez quelques années les semis apportés par les oiseaux sous les arbres voisins.",
      ],
      dispose: "Les branches à baies vont à la poubelle, pour que les oiseaux n'emportent pas les graines.",
    },
  ...
  "Lotus corniculatus": {
    ...
    careNote:
      "Semez-la dans un terrain maigre, pauvre et ensoleillé — c'est l'une des rares choses véritablement bonnes qu'on puisse faire d'un bord de route tassé ou d'un remblai de chantier — puis fauchez une seule fois, tard, en septembre. Elle fabrique son propre azote, ne la nourrissez donc jamais, et elle disparaît de tout ce qui est riche, ombragé ou tondu court.",
    givesNote:
    ...
    supportNotes: {
      ...
      "bumble-bees":
        "Une longue saison de petites fleurs jaune et orange, de mai jusqu'en septembre, butinée sans arrêt par les bourdons.",
    },
  },
  "Trifolium pratense": {
    nativeNote:
  ...
  "Poa nemoralis": {
    nativeNote:
      "La graminée souple et penchée des sous-bois et des talus de haie ombragés de France — la seule qui se plaise vraiment à l'ombre sèche sous les arbres.",
    careNote:
  ...
  "Fragaria vesca": {
    ...
    supportNotes: {
      ...
      "mason-bees":
        "Des fleurs blanches ouvertes, portées juste au-dessus du sol à partir d'avril — assez peu profondes pour que les plus petites andrènes puissent les butiner, ce que la plupart des fleurs de printemps ne sont pas.",
    },
  },
