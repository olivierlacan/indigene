...
| [`hosts/`](hosts/) | `genus-counts.json` — HOSTS, the NHM's world database of Lepidoptera host plants: distinct moth species per host genus for Australia, southern Africa, the Río de la Plata and New Zealand. The 48 MB full download is git-ignored | CC0 (NHM) | `cd app && npm run hosts:fetch` |
