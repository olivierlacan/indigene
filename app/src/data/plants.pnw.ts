...
export const SEED_RAW: RawPlant[] = [
...

  {
    ...
    family: "Pinaceae",
    form: "tree",
    nativeNote: "The spruce of the fog belt, from Alaska to Mendocino — almost never more than a few dozen miles from salt water.",
    sun: { minHours: 4, maxHours: 12 },
    moisture: ["mesic", "wet"],
    ph: { min: 4.5, max: 6.5 },
    zones: { min: 6, max: 8 },
    size: [
      ...
      { year: 10, heightFt: 28, spreadFt: 14 },
    ],
    matureHeightFt: 180,
    matureSpreadFt: 35,
    scores: { pollinator: 5, bird: 82, stormwater: 75, erosion: 80, carbon: 97, establishment: 62 },
    hostLepCount: 68,
    keystone: false,
    bloom: null,
    filters: { deerResistant: true, thorny: false, allergenic: false, petToxic: false, aggressive: false },
  ...
  },
  {
    ...
    family: "Pinaceae",
    form: "tree",
    nativeNote: "The coastal form of lodgepole — the gnarled pine of dunes, headlands and the peat bogs behind them.",
    sun: { minHours: 6, maxHours: 12 },
    ...
    matureHeightFt: 45,
    matureSpreadFt: 25,
    scores: { pollinator: 5, bird: 78, stormwater: 60, erosion: 74, carbon: 76, establishment: 90 },
    hostLepCount: 200,
    keystone: true,
    bloom: null,
    filters: { deerResistant: true, thorny: false, allergenic: true, petToxic: false, aggressive: false },
  ...
  },
  {
    ...
    family: "Rosaceae",
    form: "shrub",
    nativeNote: "The soft, thornless bramble of west-side woods, clearings and roadsides, coastal Alaska to California.",
    sun: { minHours: 2, maxHours: 9 },
    moisture: ["dry", "mesic", "wet"],
    ph: { min: 4.8, max: 7.0 },
    zones: { min: 3, max: 8 },
    ...
    matureHeightFt: 8,
    matureSpreadFt: 15,
    scores: { pollinator: 75, bird: 88, stormwater: 65, erosion: 82, carbon: 28, establishment: 92 },
    hostLepCount: 110,
    keystone: true,
  ...
  {
    id: "berberis-nervosa",
    common: "Dwarf Oregon Grape",
    latin: "Berberis nervosa",
    family: "Berberidaceae",
    form: "shrub",
    nativeNote: "The low, spreading evergreen Oregon grape of the shaded conifer-forest floor, west of the Cascades from BC to California.",
    ...
    matureHeightFt: 2,
    matureSpreadFt: 4,
    scores: { pollinator: 70, bird: 78, stormwater: 40, erosion: 55, carbon: 20, establishment: 78 },
    hostLepCount: 8,
    keystone: false,
  ...
  {
    id: "rhododendron-macrophyllum",
    common: "Pacific Rhododendron",
    latin: "Rhododendron macrophyllum",
    family: "Ericaceae",
    form: "shrub",
    nativeNote: "Washington's state flower, and the wild rhododendron of conifer edges from British Columbia to northern California.",
    ...
    matureHeightFt: 15,
    matureSpreadFt: 10,
    scores: { pollinator: 58, bird: 40, stormwater: 46, erosion: 55, carbon: 26, establishment: 45 },
    hostLepCount: 22,
    keystone: false,
  ...
  },
  {
    ...
    family: "Rosaceae",
    form: "perennial",
    nativeNote: "A tall, shrub-sized perennial of moist west-side woods, stream banks and shaded road cuts; the PNW plants are var. acuminatus.",
    sun: { minHours: 1, maxHours: 7 },
    moisture: ["mesic", "wet"],
    ph: { min: 5.0, max: 7.0 },
    zones: { min: 3, max: 8 },
    ...
    matureHeightFt: 6,
    matureSpreadFt: 5,
    scores: { pollinator: 68, bird: 30, stormwater: 50, erosion: 55, carbon: 15, establishment: 78 },
    hostLepCount: 6,
    keystone: false,
  ...
  {
    id: "sidalcea-campestris",
    common: "Meadow Checkermallow",
    latin: "Sidalcea campestris",
    family: "Malvaceae",
    form: "perennial",
    nativeNote: "A tall, pink-flowered mallow of Willamette Valley meadows, unplowed fields and roadsides — native to western Oregon.",
    sun: { minHours: 5, maxHours: 12 },
    moisture: ["dry", "mesic"],
    ph: { min: 5.5, max: 7.5 },
    zones: { min: 6, max: 9 },
    ...
    matureHeightFt: 3.5,
    matureSpreadFt: 2,
    scores: { pollinator: 88, bird: 30, stormwater: 40, erosion: 55, carbon: 12, establishment: 78 },
    hostLepCount: 15,
    keystone: false,
    bloom: { startMonth: 5, endMonth: 7, color: "pink" },
    filters: { deerResistant: false, thorny: false, allergenic: false, petToxic: false, aggressive: false },
  ...
  {
    id: "dicentra-formosa",
    common: "Pacific Bleeding Heart",
    latin: "Dicentra formosa",
    family: "Papaveraceae",
    form: "perennial",
    nativeNote: "The ferny-leaved wild bleeding heart of moist, shaded west-side woods, spreading into soft colonies by rhizome.",
    sun: { minHours: 0, maxHours: 5 },
    moisture: ["mesic", "wet"],
    ph: { min: 5.0, max: 7.0 },
    zones: { min: 3, max: 8 },
    ...
    matureHeightFt: 1.5,
    matureSpreadFt: 4,
    scores: { pollinator: 55, bird: 25, stormwater: 40, erosion: 55, carbon: 10, establishment: 78 },
    hostLepCount: 4,
    keystone: false,
    ...
    givesNote: "Early nectar for bumble bee queens, and the sole caterpillar host of the Clodius parnassian — a ghostly white butterfly of Northwest woods whose young eat nothing else. Ants carry its seeds off and sow them.",
    confidence: "high",
  ...
  {
    id: "tellima-grandiflora",
    common: "Fringecup",
    latin: "Tellima grandiflora",
    family: "Saxifragaceae",
    form: "perennial",
    nativeNote: "The tall shade wildflower of west-side stream woods and conifer understorey, Alaska to central California.",
    sun: { minHours: 0, maxHours: 6 },
    moisture: ["dry", "mesic"],
    ph: { min: 5.0, max: 7.0 },
    zones: { min: 4, max: 9 },
    ...
    matureHeightFt: 2.5,
    matureSpreadFt: 2.5,
    scores: { pollinator: 55, bird: 25, stormwater: 42, erosion: 60, carbon: 8, establishment: 92 },
    hostLepCount: 2,
    keystone: false,
    bloom: { startMonth: 4, endMonth: 6, color: "greenish-white" },
    filters: { deerResistant: true, thorny: false, allergenic: false, petToxic: false, aggressive: false },
    noWaterEstablish: true,
  ...
  {
    id: "petasites-frigidus",
    common: "Sweet Coltsfoot",
    latin: "Petasites frigidus",
    family: "Asteraceae",
    form: "perennial",
    nativeNote: "The big-leaved wetland perennial of seeps, ditches and stream terraces across the cool north, south to Oregon.",
    sun: { minHours: 0, maxHours: 6 },
    moisture: ["wet"],
    ph: { min: 5.0, max: 7.5 },
    zones: { min: 3, max: 9 },
    size: [
      ...
      { year: 3, heightFt: 1.5, spreadFt: 4 },
      { year: 5, heightFt: 1.5, spreadFt: 7 },
      { year: 10, heightFt: 1.5, spreadFt: 12 },
    ],
    matureHeightFt: 2,
    matureSpreadFt: 20,
    scores: { pollinator: 72, bird: 20, stormwater: 78, erosion: 82, carbon: 10, establishment: 88 },
    hostLepCount: 2,
    keystone: false,
    bloom: { startMonth: 2, endMonth: 4, color: "white-pink" },
    filters: { deerResistant: true, thorny: false, allergenic: false, petToxic: true, aggressive: true },
    noWaterEstablish: false,
  ...
  {
    id: "lysichiton-americanus",
    common: "Western Skunk Cabbage",
    latin: "Lysichiton americanus",
    family: "Araceae",
    form: "perennial",
    nativeNote: "The yellow lantern of west-side swamps and seeps in March, Alaska to northern California.",
    sun: { minHours: 0, maxHours: 6 },
    moisture: ["wet"],
    ph: { min: 4.5, max: 7.0 },
    zones: { min: 5, max: 9 },
    ...
    matureHeightFt: 4,
    matureSpreadFt: 5,
    scores: { pollinator: 45, bird: 30, stormwater: 86, erosion: 70, carbon: 12, establishment: 70 },
    hostLepCount: 2,
    keystone: false,
    bloom: { startMonth: 3, endMonth: 4, color: "yellow" },
    filters: { deerResistant: false, thorny: false, allergenic: false, petToxic: true, aggressive: false },
...

  {
    ...
    family: "Poaceae",
    form: "grass",
    nativeNote: "A cool-season bunchgrass of wet prairies, meadows and coastal bluffs across the west side and far beyond.",
    ...
    matureHeightFt: 3.5,
    matureSpreadFt: 2.5,
    scores: { pollinator: 5, bird: 60, stormwater: 70, erosion: 85, carbon: 30, establishment: 88 },
    hostLepCount: 28,
    keystone: false,
    bloom: { startMonth: 6, endMonth: 8, color: "tan" },
    filters: { deerResistant: true, thorny: false, allergenic: false, petToxic: false, aggressive: false },
    noWaterEstablish: false,
  ...
  },
  {
    ...
    family: "Berberidaceae",
    form: "groundcover",
    nativeNote: "The three-part leaf that carpets shaded west-side conifer floors, British Columbia to northern California.",
    sun: { minHours: 0, maxHours: 4 },
    moisture: ["mesic"],
    ph: { min: 5.0, max: 6.5 },
    zones: { min: 5, max: 9 },
    size: [
      ...
      { year: 5, heightFt: 0.9, spreadFt: 3.5 },
      { year: 10, heightFt: 1, spreadFt: 6 },
    ],
    matureHeightFt: 1.2,
    matureSpreadFt: 10,
    scores: { pollinator: 35, bird: 15, stormwater: 46, erosion: 68, carbon: 8, establishment: 78 },
    hostLepCount: 2,
    keystone: false,
    bloom: { startMonth: 4, endMonth: 6, color: "white" },
    filters: { deerResistant: true, thorny: false, allergenic: false, petToxic: false, aggressive: false },
  ...
  {
    id: "viola-glabella",
    common: "Stream Violet",
    latin: "Viola glabella",
    family: "Violaceae",
    form: "groundcover",
    nativeNote: "The yellow violet of damp shade along west-side streams and trails, Alaska to central California.",
    sun: { minHours: 0, maxHours: 5 },
    moisture: ["mesic", "wet"],
    ph: { min: 5.0, max: 7.0 },
    zones: { min: 4, max: 9 },
    size: [
      ...
      { year: 3, heightFt: 0.5, spreadFt: 1.5 },
      { year: 5, heightFt: 0.6, spreadFt: 2.5 },
      { year: 10, heightFt: 0.6, spreadFt: 4 },
    ],
    matureHeightFt: 0.8,
    matureSpreadFt: 5,
    scores: { pollinator: 55, bird: 20, stormwater: 44, erosion: 60, carbon: 6, establishment: 82 },
    hostLepCount: 20,
    keystone: true,
    bloom: { startMonth: 4, endMonth: 6, color: "yellow" },
    filters: { deerResistant: true, thorny: false, allergenic: false, petToxic: false, aggressive: false },
