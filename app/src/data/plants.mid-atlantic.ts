...
export const SEED_RAW: RawPlant[] = [
  ...
  },
  {
    ...
    family: "Malvaceae",
    form: "tree",
    nativeNote: "The bee tree of rich Piedmont slopes — you hear it flowering before you see it.",
  ...
  },
  {
    ...
    family: "Pinaceae",
    form: "tree",
    nativeNote: "The dark evergreen of cool north-facing ravines, holding the coldest water in the Piedmont.",
    ...
    matureHeightFt: 65,
    matureSpreadFt: 30,
    scores: { pollinator: 5, bird: 70, stormwater: 55, erosion: 65, carbon: 78, establishment: 55 },
    hostLepCount: 45,
    keystone: false,
  ...
  },
  {
    ...
    family: "Pinaceae",
    form: "tree",
    nativeNote: "Pennsylvania's state tree — soft five-needle bundles, and the tallest thing in the woods.",
    sun: { minHours: 5, maxHours: 12 },
    moisture: ["dry", "mesic"],
    ph: { min: 4.5, max: 7.0 },
    zones: { min: 3, max: 8 },
