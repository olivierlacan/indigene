...
|---|---|---|
| **Framework** | **None.** Vanilla TS + DOM + real web APIs, bundled by Vite. Zero runtime deps. | Per direction ("Do not use React… respect the DOM"). Keeps the bundle ~484 KB gzipped (plus one region's plant list) and the code legible. |
