...
- Internal: `npm run invasives:count` counts each most-wanted plant's wild
  ...
  ratings (57/57 agree); its Grand Est reader finds a species' table row rather
  than a passing mention in the introduction. Share cards come from
  `scripts/gen-invasive-cards.mjs`.
...
- **And the creatures those plants feed.** The region and its plants now name
  the butterflies, moths, bees, birds and mammals they support — 23 kinds,
  including the endangered Karner blue, whose caterpillars eat only wild lupine.
  [Meet them](https://indigene.app/wildlife)
