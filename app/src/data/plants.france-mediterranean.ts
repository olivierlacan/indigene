...
export const SEED_RAW: RawPlant[] = [
  ...
  {
    id: "pyrus-spinosa",
    common: "Almond-leaved Pear (Poirier à feuilles d'amandier)",
    latin: "Pyrus spinosa",
    family: "Rosaceae",
    form: "tree",
    nativeNote: "The wild pear of the southern hillsides — thorny, narrow-leaved and grey, on dry limestone slopes and old terraces from Languedoc to the Alpes-Maritimes.",
    sun: { minHours: 6, maxHours: 12 },
    moisture: ["dry"],
    ph: { min: 6.5, max: 8.3 },
    zones: { min: 7, max: 10 },
    ...
    matureHeightFt: 26,
    matureSpreadFt: 20,
    scores: { pollinator: 86, bird: 80, stormwater: 40, erosion: 62, carbon: 44, establishment: 84 },
    hostLepCount: 123,
    keystone: true,
  ...
  {
    id: "sorbus-domestica",
    common: "Service Tree (Cormier)",
    latin: "Sorbus domestica",
    family: "Rosaceae",
    form: "tree",
    nativeNote: "Scattered through the warm southern hills and old field edges — a tree people used to plant for its fruit and then forgot, and one of the longest-lived broadleaves in France.",
    sun: { minHours: 6, maxHours: 12 },
    moisture: ["dry", "mesic"],
    ph: { min: 6.0, max: 8.3 },
    zones: { min: 6, max: 9 },
    ...
    matureHeightFt: 50,
    matureSpreadFt: 30,
    scores: { pollinator: 74, bird: 84, stormwater: 48, erosion: 60, carbon: 62, establishment: 76 },
    hostLepCount: 109,
    keystone: true,
  ...
  },
  {
    ...
    common: "Hawthorn (Aubépine à un style)",
    latin: "Crataegus monogyna",
    family: "Rosaceae",
    form: "shrub",
    nativeNote: "In every hedge, thicket and abandoned terrace of the Midi — the single most recorded woody plant in this region, and the one most gardens already have a piece of.",
    sun: { minHours: 5, maxHours: 12 },
    moisture: ["dry", "mesic"],
    ph: { min: 6.0, max: 8.3 },
    zones: { min: 5, max: 9 },
    ...
    matureHeightFt: 26,
    matureSpreadFt: 22,
    scores: { pollinator: 86, bird: 92, stormwater: 52, erosion: 74, carbon: 50, establishment: 92 },
    hostLepCount: 203,
    keystone: false,
    bloom: { startMonth: 4, endMonth: 5, color: "white" },
    filters: { deerResistant: true, thorny: true, allergenic: false, petToxic: false, aggressive: false },
    ...
    givesNote: "**The biggest single food plant this list was missing**: 203 caterpillar species, more than anything here but the oaks. A week of blossom that every bee and beetle in the garrigue works, thorny cover that keeps a nest safe from cats and jays, and red haws that carry thrushes and blackcaps through the winter.",
    confidence: "high",
  ...
  {
    id: "artemisia-alba",
    common: "White Wormwood (Armoise blanche)",
    latin: "Artemisia alba",
    family: "Asteraceae",
    form: "shrub",
    nativeNote: "A silver, finely cut subshrub of dry limestone garrigue and rocky steppe, and one of the plants that gives the Provençal hillside its smell in August.",
    ...
    size: [
      ...
      { year: 3, heightFt: 1.2, spreadFt: 1.6 },
      { year: 5, heightFt: 1.8, spreadFt: 2.2 },
      { year: 10, heightFt: 2, spreadFt: 2.6 },
    ],
    matureHeightFt: 2.5,
    matureSpreadFt: 3,
    scores: { pollinator: 58, bird: 30, stormwater: 26, erosion: 76, carbon: 14, establishment: 88 },
    hostLepCount: 143,
    keystone: true,
    bloom: { startMonth: 8, endMonth: 9, color: "yellow" },
    filters: { deerResistant: true, thorny: false, allergenic: true, petToxic: false, aggressive: false },
    noWaterEstablish: true,
    ...
    givesNote: "143 caterpillar species — an enormous figure for a plant this size, and the second biggest on this list after the oaks and hawthorn. It flowers in August and September when the garrigue has almost nothing else open, and the silver foliage holds its colour right through the drought.",
    confidence: "high",
  ...
  {
    id: "genista-scorpius",
    common: "Scorpion Broom (Genêt épineux)",
    latin: "Genista scorpius",
    family: "Fabaceae",
    form: "shrub",
    nativeNote: "The spiny yellow broom of Languedoc and Provençal garrigue — the one that makes a limestone hillside gold in April and impassable in trousers.",
    sun: { minHours: 7, maxHours: 12 },
    moisture: ["dry"],
    ph: { min: 6.5, max: 8.5 },
    zones: { min: 7, max: 10 },
    size: [
      ...
      { year: 10, heightFt: 4.5, spreadFt: 4.5 },
    ],
    matureHeightFt: 6,
    matureSpreadFt: 6,
    scores: { pollinator: 84, bird: 54, stormwater: 28, erosion: 84, carbon: 20, establishment: 90 },
    hostLepCount: 134,
    keystone: true,
  ...
  {
    id: "cytisus-villosus",
    common: "Hairy Broom (Cytise velu)",
    latin: "Cytisus villosus",
    family: "Fabaceae",
    form: "shrub",
    nativeNote: "A broom of the acid maquis — the Maures, the Esterel and Corsica — where the soil turns from limestone to schist and granite and the whole flora changes with it.",
    sun: { minHours: 6, maxHours: 12 },
    moisture: ["dry"],
    ph: { min: 4.5, max: 6.8 },
    zones: { min: 8, max: 10 },
    ...
    matureHeightFt: 9,
    matureSpreadFt: 7,
    scores: { pollinator: 82, bird: 52, stormwater: 30, erosion: 80, carbon: 22, establishment: 86 },
    hostLepCount: 117,
    keystone: true,
    bloom: { startMonth: 4, endMonth: 6, color: "yellow" },
    filters: { deerResistant: true, thorny: false, allergenic: false, petToxic: true, aggressive: false },
  ...
  },
  {
    ...
    family: "Ericaceae",
    form: "shrub",
    nativeNote: "On the acid ground of the Maures, the Esterel, the Cévennes edge and Corsica — the same plant as the northern moors, living here on sandstone and granite where the limestone runs out.",
    sun: { minHours: 6, maxHours: 12 },
    moisture: ["dry", "mesic"],
    ph: { min: 4.0, max: 6.0 },
    zones: { min: 5, max: 9 },
    ...
    matureHeightFt: 2,
    matureSpreadFt: 3,
    scores: { pollinator: 92, bird: 56, stormwater: 40, erosion: 74, carbon: 20, establishment: 72 },
    hostLepCount: 118,
    keystone: false,
  ...
  {
    id: "corylus-avellana",
    common: "Hazel (Coudrier)",
    latin: "Corylus avellana",
    family: "Betulaceae",
    form: "shrub",
    nativeNote: "In the shaded, deeper soils of the southern hinterland — north-facing slopes, streamside woods and the cooler valleys behind the coast, where the garrigue gives way to real shade.",
    sun: { minHours: 2, maxHours: 9 },
    moisture: ["mesic"],
    ph: { min: 6.0, max: 8.2 },
    zones: { min: 5, max: 9 },
    ...
    matureHeightFt: 18,
    matureSpreadFt: 16,
    scores: { pollinator: 40, bird: 80, stormwater: 58, erosion: 68, carbon: 48, establishment: 82 },
    hostLepCount: 124,
    keystone: false,
    bloom: { startMonth: 1, endMonth: 3, color: "yellow" },
    filters: { deerResistant: false, thorny: false, allergenic: true, petToxic: false, aggressive: false },
    noWaterEstablish: false,
    careNote: "The one shrub here that actively wants shade and a soil that holds some moisture — a north wall, under bigger trees, the bottom of a shaded slope. It will not take the full blast of a coastal summer on thin limestone, and it is the rare row on this list that appreciates a deep soak in a bad August.",
  ...
  {
    id: "rumex-acetosella",
    common: "Sheep's Sorrel (Petite Oseille)",
    latin: "Rumex acetosella",
    family: "Polygonaceae",
    form: "perennial",
    nativeNote: "On the acid sands and thin schist soils of the Maures, the Esterel and Corsica, and anywhere the limestone gives out — small, sharp-tasting, and far more important than it looks.",
    sun: { minHours: 5, maxHours: 12 },
    moisture: ["dry"],
    ph: { min: 4.0, max: 6.5 },
    zones: { min: 4, max: 10 },
    ...
    matureHeightFt: 1.2,
    matureSpreadFt: 3,
    scores: { pollinator: 16, bird: 58, stormwater: 34, erosion: 66, carbon: 12, establishment: 92 },
    hostLepCount: 199,
    keystone: true,
    bloom: { startMonth: 4, endMonth: 7, color: "red" },
    filters: { deerResistant: false, thorny: false, allergenic: true, petToxic: false, aggressive: true },
    noWaterEstablish: true,
    careNote: "Acid, poor, dry ground in sun — it is a plant of ground nobody has improved. It travels at the root and will colonise a gravel bed, which is useful on a bank and a nuisance in a border, so give it an edge to hold rather than a bed to share.",
    givesNote: "199 caterpillar species, third only to the oaks and hawthorn on this whole list — and the food plant of the small copper, the little flashing orange butterfly of dry southern verges. Wind-pollinated, so the flowers are for the caterpillars; the rusty seed heads feed finches.",
    confidence: "high",
  ...
  },
  {
    ...
    common: "Red Clover (Trèfle commun)",
    latin: "Trifolium pratense",
    family: "Fabaceae",
    form: "perennial",
    nativeNote: "Through the damper meadows, roadsides and old pasture of the southern interior, wherever the ground holds a little moisture into early summer.",
    sun: { minHours: 5, maxHours: 12 },
    moisture: ["mesic"],
    ph: { min: 5.5, max: 8.0 },
    zones: { min: 4, max: 9 },
    ...
    matureHeightFt: 2,
    matureSpreadFt: 2.5,
    scores: { pollinator: 92, bird: 44, stormwater: 46, erosion: 70, carbon: 18, establishment: 88 },
    hostLepCount: 107,
    keystone: false,
    bloom: { startMonth: 4, endMonth: 9, color: "pink" },
    filters: { deerResistant: false, thorny: false, allergenic: false, petToxic: false, aggressive: false },
    noWaterEstablish: true,
  ...
  {
    id: "festuca-ovina",
    common: "Sheep's Fescue (Fétuque des moutons)",
    latin: "Festuca ovina",
    family: "Poaceae",
    form: "grass",
    nativeNote: "The fine blue-grey tussock grass of dry southern grassland, garrigue clearings and thin rocky soil — the grass the sheep left behind because it is too tough to be worth eating.",
    sun: { minHours: 6, maxHours: 12 },
    moisture: ["dry"],
    ph: { min: 5.0, max: 8.3 },
    zones: { min: 4, max: 9 },
    ...
    matureHeightFt: 1.5,
    matureSpreadFt: 1.5,
    scores: { pollinator: 4, bird: 56, stormwater: 40, erosion: 86, carbon: 20, establishment: 92 },
    hostLepCount: 190,
    keystone: true,
    bloom: { startMonth: 5, endMonth: 6, color: "green" },
    filters: { deerResistant: true, thorny: false, allergenic: true, petToxic: false, aggressive: false },
    noWaterEstablish: true,
    careNote: "Dry, poor, sunny and sharply drained — it holds its blue colour through the worst of the drought and needs no water at all. Comb the dead blades out with your fingers in spring rather than cutting it.",
    ...
    propagation: {
      methods: ["division", "seed-direct"],
      note: "Split a tussock in autumn or early spring — the simplest division on this list. Seed sown onto raked bare ground in autumn germinates with the winter rain.",
      basis: "Conservatoire botanique national méditerranéen.",
    },
  },
  // ---------------- VINES ----------------
  ...
  {
    id: "rosa-sempervirens",
    common: "Evergreen Rose (Églantier sempervirent)",
    latin: "Rosa sempervirens",
    family: "Rosaceae",
    form: "vine",
    nativeNote: "The Mediterranean wild rose — scrambling up through maquis, hedges and holm-oak edges all round the southern coast, and keeping its glossy leaves all winter, which no other rose here does.",
    sun: { minHours: 4, maxHours: 11 },
    moisture: ["dry", "mesic"],
    ph: { min: 6.0, max: 8.2 },
    zones: { min: 7, max: 10 },
    ...
    matureHeightFt: 20,
    matureSpreadFt: 13,
    scores: { pollinator: 78, bird: 84, stormwater: 42, erosion: 68, carbon: 28, establishment: 86 },
    hostLepCount: 111,
    keystone: true,
...

  {
    ...
    common: "Bird's-foot Trefoil (Lotier commun)",
    latin: "Lotus corniculatus",
    family: "Fabaceae",
    form: "groundcover",
    nativeNote: "Low yellow and orange pea flowers through dry southern grassland, verges and garrigue clearings, from the coast to the foot of the mountains.",
    sun: { minHours: 6, maxHours: 12 },
    moisture: ["dry", "mesic"],
    ph: { min: 5.5, max: 8.3 },
    zones: { min: 4, max: 10 },
    ...
    matureHeightFt: 1,
    matureSpreadFt: 2.5,
    scores: { pollinator: 92, bird: 40, stormwater: 38, erosion: 78, carbon: 16, establishment: 90 },
    hostLepCount: 115,
    keystone: true,
    bloom: { startMonth: 4, endMonth: 9, color: "yellow" },
    filters: { deerResistant: false, thorny: false, allergenic: false, petToxic: false, aggressive: false },
    noWaterEstablish: true,
