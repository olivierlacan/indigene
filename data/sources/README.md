...
| [`resolve-ecoregions/`](resolve-ecoregions/) | `probe.json` — does the hosted RESOLVE Ecoregions 2017 layer answer a point query in Sydney, Auckland, Cape Town and Buenos Aires, from a browser? Gates every southern region's ecoregion codes | CC BY 4.0 (RESOLVE) | `cd app && npm run probe:resolve` |
