...
const AREA_WORDS = {
  ...
  pnw: { en: "Washington, Oregon and British Columbia", fr: "Washington, l'Oregon et la Colombie-Britannique" },
  ...
  "nz-auckland": { en: "the North Island of New Zealand", fr: "l'île du Nord de Nouvelle-Zélande" },
